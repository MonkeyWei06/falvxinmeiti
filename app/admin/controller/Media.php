...
class Media extends Common
{
    ...
    public function _initialize()
    {
        ...
        $this->assign('MediaWebNameID',$this->GetCurrentWholeType(18));//	频道类型
        $this->assign('MediaIndustryID',$this->GetCurrentWholeType(35));//综合门户媒体
        $this->assign('MediaCityID',$this->GetCityTypeList('0'));//覆盖区域
        $this->assign('MediaInLevelID',$this->GetCurrentWholeType(110));//入口级别
        $this->assign('MediaUrlTypeID',$this->GetCurrentWholeType(59));//链接类型
        $this->assign('MediaSpeedID',$this->GetCurrentWholeType(66));//发稿速度
        $this->assign('MediaNewsSourceID',$this->GetCurrentWholeType(73));//新闻源
        $this->assign('MediaCanSendID',$this->GetCurrentWholeType(76));//周末可发
        $this->assign('MediaSpecialIndustryID',$this->GetCurrentWholeType(79));//特别行业
        $this->assign('MediaSituationID',$this->GetCurrentWholeType(85));//收录情况
        $this->assign('MediaComputerWeightID',$this->GetCurrentWholeType(88));//电脑权重
        $this->assign('MediaMobileWeightID',$this->GetCurrentWholeType(99));//移动权重
    }
    ...
    public function GetListInfo($UrlParam)
    {
        ...
        $Info=Db::name('media')->where($Where)->order('MediaID desc')->select();
        return $Info;
    }
}